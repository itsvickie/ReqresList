...
export class UserListPage {
  ...
  openEditUser(id: number){
    ...
    .catch((error: any) => {
      this.toast.create({ message: "Erro ao recuperar o usuário. Erro: " + error.error, position: 'button', duration: 3000}).present();
    })
  }
  ...
  deleteUser(user: any){
    ...
    .then((result: any) => {
      ...
      this.toast.create({ message: "Usuário excluído com sucesso.", position: 'button', duration: 3000}). present();
    })
    .catch((error: any) => {
      this.toast.create({ message: "Erro ao excluir o usuário. Erro: " + error.error, position: 'button', duration: 3000}).present();
    })
  }
}